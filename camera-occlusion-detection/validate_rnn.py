...
def validate(data_type, model, seq_length=200, saved_model=None,
...
def main():
    model = 'lstm'
    saved_model = 'data/checkpoints/lstm-features.104-0.413.hdf5'
    ...
    validate(data_type, model, saved_model=saved_model,
             image_shape=image_shape, class_limit=5)
